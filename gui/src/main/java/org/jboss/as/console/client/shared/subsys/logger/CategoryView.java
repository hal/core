...
public class CategoryView {
    ...
    private static final AddressTemplate BASE_ADDRESS =
            AddressTemplate.of("{selected.profile}/subsystem=logging/logger=*");
    ...
    public Widget asWidget() {
        ...
        TextColumn<Property> enabledColumn = new TextColumn<Property>() {
            @Override
            public String getValue(Property node) {
                return String.valueOf(node.getValue().get("level").asString());
            }
        };

        table.addColumn(nameColumn, "Name");
        table.addColumn(enabledColumn, "Level");
        ...
        tools.addToolButtonRight(new ToolButton(Console.CONSTANTS.common_label_delete(), new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                Feedback.confirm(Console.MESSAGES.deleteTitle("Log Category"),
                        Console.MESSAGES.deleteConfirm("Log Category '" + getCurrentSelection().getName() + "'"),
        ...
        formAssets.getForm().setToolsCallback(new FormCallback() {
            ...
            public void onSave(Map changeset) {
                presenter.onSaveNamedResource(BASE_ADDRESS, getCurrentSelection().getName(), changeset);
            }
