 ...
 */
public class MechanismProviderFilteringSaslSserverFactoryView extends ElytronGenericResourceView {

    private MechanismProviderFilteringSaslServerFilterEditor filterEditor;

    public MechanismProviderFilteringSaslSserverFactoryView(final Dispatcher circuit,
    ...
    public Map<String, Widget> additionalTabDetails() {
        ...
        filterEditor = new MechanismProviderFilteringSaslServerFilterEditor(circuit, resourceDescription, securityContext);
