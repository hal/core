 ...
 * @author Harald Pehl
 */
public class RefreshLogFile implements Action {

    private final String name;

    public RefreshLogFile(String name) {
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshLogFile)) return false;

        RefreshLogFile that = (RefreshLogFile) o;
