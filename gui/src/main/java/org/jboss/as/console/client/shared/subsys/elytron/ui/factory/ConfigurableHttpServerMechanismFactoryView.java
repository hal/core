 ...
 */
public class ConfigurableHttpServerMechanismFactoryView extends ElytronGenericResourceView {

    private ConfigurableHttpServerMechanismFactoryFilterEditor filterEditor;

    public ConfigurableHttpServerMechanismFactoryView(final Dispatcher circuit,
    ...
    public Map<String, Widget> additionalTabDetails() {
        ...
        filterEditor = new ConfigurableHttpServerMechanismFactoryFilterEditor(circuit, resourceDescription, securityContext);
