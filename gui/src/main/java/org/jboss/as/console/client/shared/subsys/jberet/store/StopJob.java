 ...
 */
public class StopJob implements JberetMetricAction {
    ...
    public StopJob(final String deploymentName, final String subDeploymentName, final String jobName, String executionId) {
