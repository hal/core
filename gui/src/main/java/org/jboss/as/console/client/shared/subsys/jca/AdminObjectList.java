 ...
 * @author Heiko Braun
 */
public class AdminObjectList {


    private final ResourceAdapterPresenter presenter;
    private final static AddressTemplate ADDRESS_TEMPLATE = AddressTemplate.of("{selected.profile}/subsystem=resource-adapters/resource-adapter=*/admin-objects=*");
    ...
    public Widget asWidget() {
        ...
        tools.addToolButtonRight(new ToolButton(Console.CONSTANTS.common_label_delete(), new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                Feedback.confirm(Console.MESSAGES.deleteTitle("Admin Object"),
                        Console.MESSAGES.deleteConfirm(" Admin Object '" + getCurrentSelection().getName() + "'"),
        ...
        SubResourcePropertyManager propertyManager = new SubResourcePropertyManager(PROPS_ADDRESS, presenter.getStatementContext(), presenter.getDispatcher())
        {
            ...
            public void onAdd(Property property, AddPropertyDialog addDialog) {
                ...
                AdminObjectList.this.addDialog.hide();
            }
