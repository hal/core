 ...
 * @since 19/08/14
 */
public class CSPPresenter extends ManualRevealPresenter<CSPPresenter.MyView, CSPPresenter.MyProxy> {
    ...
    public interface MyProxy extends ProxyPlace<CSPPresenter> {
    }
