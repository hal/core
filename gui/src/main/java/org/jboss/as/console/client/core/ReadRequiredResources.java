...
public class ReadRequiredResources implements Function<RequiredResourcesContext> {
    ...
    public void add(String requiredResource) {
        ResourceRef ref = new ResourceRef(requiredResource);
        ResourceAddress address = new ResourceAddress(requiredResource, statementContext);
        ...
        operation.get(RECURSIVE).set(true); // TODO Does this work for big resources like '/subsystem=infinispan'?
