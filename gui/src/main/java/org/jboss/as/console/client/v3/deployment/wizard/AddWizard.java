 ...
 * @author Harald Pehl
 */
public abstract class AddWizard extends DeploymentWizard {

    public AddWizard(BootstrapContext bootstrapContext, BeanFactory beanFactory,
    ...
    private void upload(final Outcome<FunctionContext> outcome) {
