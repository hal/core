 ...
 * @author Harald Pehl
 */
class IdentityProviderHandlerEditor extends MasterDetailEditor {
        ...
        public HandlerContext(final StatementContext delegate) {
            super(delegate, new Filter() {
                public String filter(String key) {
                    ...
                    } else if ("identity.provider".equals(key)) {
                        return presenter.getIdentityProvider();
    ...
    IdentityProviderHandlerEditor(final FederationPresenter presenter,
            final DispatchAsync dispatcher,
