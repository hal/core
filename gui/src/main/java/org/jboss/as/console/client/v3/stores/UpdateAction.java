 ...
 * @author Harald Pehl
 */
public abstract class UpdateAction implements Action {

    private final AddressTemplate addressTemplate;
    private final Map<String, Object> changedValues;
    private final String instanceName;

    public UpdateAction(AddressTemplate addressTemplate, String instanceName, Map<String, Object> changedValues) {
    ...
    public boolean equals(Object o) {
        ...
        if (!addressTemplate.equals(that.addressTemplate)) return false;
