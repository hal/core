 ...
 */
public class ConstantPermissionMapperView extends ElytronGenericResourceView {

    private ConstantPermissionMappingEditor permissionMapping;

    public ConstantPermissionMapperView(final Dispatcher circuit,
        ...
        excludesFormAttributes("permissions");
    }

    @Override
    public Map<String, Widget> additionalTabDetails() {
        Map<String, Widget> additionalWidgets = new HashMap<>();
        permissionMapping = new ConstantPermissionMappingEditor(circuit, resourceDescription, securityContext);
        additionalWidgets.put("Permissions", permissionMapping.asWidget());
