 ...
 * @since 08/09/14
 */
public class IIOPSvcView {

    final static AddressTemplate ADDRESS =
            AddressTemplate.of("{selected.profile}/subsystem=ejb3/service=iiop");

    private final EJB3Presenter presenter;
    private ModelNodeForm commonForm;

    public IIOPSvcView(EJB3Presenter presenter) {
    ...
    public Widget asWidget() {
        ...
        FormCallback callback = new FormCallback() {
            ...
            public void onSave(Map changeset) {
                ...
                {
                    presenter.onCreateResource(ADDRESS, null, commonForm.getUpdatedEntity());
                }
            }
