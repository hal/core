...
public class WebSocketView {
    ...
    final static AddressTemplate ADDRESS =
            AddressTemplate.of("{selected.profile}/subsystem=undertow/servlet-container=*/setting=websockets");

    private final ServletPresenter presenter;
    private ModelNodeForm commonForm;

    public WebSocketView(ServletPresenter presenter) {
    ...
    public Widget asWidget() {
        ...
        OneToOneLayout layoutBuilder = new OneToOneLayout()
                .setPlain(true)
                .setHeadline("Web Socket Settings")
