 ...
 * @author Harald Pehl
 */
public class UpdateConnector extends UpdateAction {
    public UpdateConnector(AddressTemplate addressTemplate, String instanceName, Map<String, Object> changedValues) {
