 ...
 */
public class KeyStoreAliasView implements IsWidget {
    ...
    public Widget asWidget() {
        ...
        Column<Property, String> creationDateColumn = new TextColumn<Property>() {
            @Override
            public String getValue(Property property) {
                return retrieveValue(property, "creation-date");
            }
        };
        Column<Property, String> entryTypeColumn = new TextColumn<Property>() {
            @Override
            public String getValue(Property property) {
                return retrieveValue(property, "entry-type");
            }
        };
        entryTypeColumn.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_CENTER);
        creationDateColumn.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_CENTER);
        ...
        table.addColumn(entryTypeColumn, "Type");
        table.setColumnWidth(nameColumn, 30, Style.Unit.PCT);
        table.setColumnWidth(creationDateColumn, 40, Style.Unit.PCT);
        table.setColumnWidth(entryTypeColumn, 20, Style.Unit.PCT);
    ...
    public void update(List<Property> aliases) {
    ...
    private String retrieveValue(Property property, String attrName) {
        String value = "";
