 ...
 * @author Harald Pehl
 */
public class ReadLogFilesForRefresh implements Action {

    private final String name;

    public ReadLogFilesForRefresh(String name) {
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReadLogFilesForRefresh)) return false;

        ReadLogFilesForRefresh that = (ReadLogFilesForRefresh) o;
