...
public class UserEditor implements IsWidget {
    ...
    public UserEditor(final RoleAssignmentPresenter presenter) {
    ...
    public Widget asWidget() {
        ...
        // header and desc
        content.add(new ContentHeaderLabel(Console.CONSTANTS.common_label_users()));
        content.add(new ContentDescription(Console.CONSTANTS.administration_user_assignment()));
        ...
        // table
        table = new RoleAssignmentTable(USER);
        content.add(table);
